        ...
        implements Map<K, V>
{
    ...
    public V put(K key, V value)
    {
        ...
        {
            occupied++;
            array[currentPos] = new HashMap1.HashEntry(key, value, true);
        }
    ...
    {
        return new HashMap1.EntrySetClass();
    }
    ...
    private class EntrySetClass extends AbstractSet<Map.Entry<K, V>>
    {
        ...
        {
            return new HashMap1.EntrySetIterator();
        }
    }
    ...
    private class EntrySetIterator implements Iterator<Map.Entry<K, V>>
    {
        ...
        public HashMap1.HashEntry nextEntry()
        {
            if (!hasNext())
            {
     ...
     */
    private static boolean isActive(HashMap1.HashEntry[] arr, int pos)
    {
    ...
    private void rehash()
    {
        HashMap1.HashEntry[] oldArray = array;
    ...
    {
        array = new HashMap1.HashEntry[nextPrime(arraySize)];
    }
    ...
    private HashMap1.HashEntry[] array;
}
