...
public class Easy extends Game
{
    ...
    /**
     * Construct an instance of the Easy Game. <p> The real work happens in
     * init().
     */
    public Easy()
    {
    ...
    /**
     * Create a copy of the current position of this Game. <p> Does not call
     * super.clone(), in order not to copy Observers.
     *
     * @return the copy.
     */
    public Game copy()
    ...
    private class EasyGameStrings extends GameStrings
    {
         ...
         *
         * @param s the String containing the Move.
         *
         * @return the corresponding Move.
         * @throws NoSuchMoveException or IllegalMoveException
         */
