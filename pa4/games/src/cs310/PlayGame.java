...
public class PlayGame
{
     ...
     *
     * @param args [-c|-cg] GameName [PlayerName1 PlayerName2] PlayerName1
     * defaults to human. PlayerName2 defaults to cs310.Backtrack.
     *
     * -c: flag for using GUI-compatible controller -cg: use GUI view and
     * GUI-compatible controller
     */
            ...
            throws GameException
    {
        ...
        if (useController)
        { // GUI-compatible (MVC = model-view-controller)
     ...
     *
     * @param playOnce the single game being played
     *
     */
            ...
            String secondPlayerName)
    {
        ...
        String line1 = String.format("First player (%s) used %5.3f secs per move (CPU = %5.3f secs)",
                                     firstPlayerName,
                                     timer.getElapsedSecondsPerMove(Game.FIRST_PLAYER),
                                     timer.getCPUSecondsPerMove(Game.FIRST_PLAYER));
        t.println(line1);
        String line2 = String.format("Second player (%s) used %5.3f secs per move (CPU = %5.3f secs)",
                                     secondPlayerName,
